...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    susTradingCoAuthUserSubject.add(
      SusTradingCoAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SusTradingCoAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SusTradingCoAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SusTradingCoAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    susTradingCoAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SusTradingCoAuthUser? currentUser;
